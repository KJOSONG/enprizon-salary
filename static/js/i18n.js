...
const I18N_DICT = {
  zh: {
    ...
    obj_auto_fill: '实际出渣量由当日井下采集自动带出（只读）',
  ...
  en: {
    ...
    obj_auto_fill: 'Actual output auto-filled from daily underground collection (read-only)',
    ...
    oa_field_custom_number: 'Custom Number',
