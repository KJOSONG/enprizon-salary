...
const I18N_DICT = {
  zh: {
    ...
    btn_confirm: '确认',
    col_att_hint: '默认全部为出勤(P)，点击行修改',
    /* P10 评分班组 */
    emp_team: '班组',
    emp_no_team: '未分班',
    emp_custom_number: '自定义工号',
    groups_title: '评分班组',
    btn_add: '添加',
    btn_rename: '改名',
    /* P10 评分录入 */
  ...
  en: {
    ...
    btn_confirm: 'Confirm',
    col_att_hint: 'All default to Present (P), click to modify',
    /* P10 Scoring teams */
    emp_team: 'Team',
    emp_no_team: 'Unassigned',
    emp_custom_number: 'Custom Number',
    ...
    perm_source_role: 'Role Inherited',
    ...
    perm_module_production: 'Production',
